...
let FamouseQuote:string=("Napolean Hil");
...
let names : string[] =["Aqsa", "Shaikhzadi", "Nida", "Maira"];
for(let i = 0; i < names.length; i++){
    console.log(names[i]);
}

let Ynames: string[]= ["Shaikh", "Ziddi", "Queeen", "Khan"]
for(let i=0; i < names.length; i++){
    console.log(Ynames[i]);
}
let Names : string [] = ["Neha", "Asma", "Darakhsahn"];
...
let cars : string [] = ["esla", "Toyota", "Ford", "Honda", "BMW", "Audi"];
for(let car of cars){
...
// Stating the name of the guest who can’t make it.
    ...
    let friendwhocantmakeit : string = "Maira"
...
// // Replacing the name of the guest who can’t make it with the name of the new person you are inviting.
     ...
     let indexoffriendwhocantmakeit: number = friends.indexOf (friendwhocantmakeit)
    console.log(indexoffriendwhocantmakeit)

if (indexoffriendwhocantmakeit !== -1) {friends [indexoffriendwhocantmakeit]= newfriend
...
let friendlist : string [] =["Shiza", "Ayesha", "Mehak", "Mano", "Anaya"]
...
let travelDestination : string [] = ["Banjosa Lake", "Lahore City Tour","Islamabad Sightseeing",
...
let arrayError: string [] = ["Mehak", "Hina", "Tania", "Zoha"];
...
let cities: string[] = ["Karachi", "Lahore", "Islamabad", "Gilgit"]
...
let colourofAlien : string = "Green";
...
let aliencolour2 : string = "Yellow";
...
let favorite_fruits : string [] = ["Mango", "Orange", "Pomegranate"]
...
let usernames : string []= ["Mano", "Sana", "Rania", "Admin", "Komal"];
...
let current_users :string []= ["Neha", "Sana", "Mehak", "Laiba", "Rania"]

// List of new_users

let new_users :string []= ["Mano", "Alishba", "sana", "Rania", "Gul"]
...
let pizza: string [] = ["Malai boti", "Creamy Pizza", "Chicken tikka"]
